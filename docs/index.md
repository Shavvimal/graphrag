...
For a deeper dive into the main sub-systems, please visit the docpages for the [Indexer](../docs/index/overview) and [Query](../docs/query/overview) packages.
...
- [_Global Search_](../docs/query/0-global_search) for reasoning about holistic questions about the corpus by leveraging the community summaries.
- [_Local Search_](../docs/query/1-local_search) for reasoning about specific entities by fanning-out to their neighbors and associated concepts.

### Prompt Tuning

Using _GraphRAG_ with your data out of the box may not yield the best possible results.
We strongly recommend to fine-tune your prompts following the [Prompt Tuning Guide](../docs/prompt_tuning/overview/) in our documentation.
